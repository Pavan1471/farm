...
const HorizontalCardProduct = ({category, heading}) => {
    ...
    const fetchData = async() =>{
        ...
        // console.log(categoryProduct.data.farmer)
                ...
                return(
                    <Link to={"product/"+product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex'>
                        ...
                        <div className='p-2 grid'>
                            ...
                            <p className='capitalize text-slate-500'>{product?.farmerLocation}</p>
                            <p className='capitalize text-slate-500'>Seller: {product?.farmerName}</p>
